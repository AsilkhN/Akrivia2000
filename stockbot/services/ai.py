...
SYSTEM_PROMPT = (
    ...
    "- Never assert a corporate relationship (parent, subsidiary, acquirer, "
    "merger partner) between two companies unless the facts or headlines say "
    "so explicitly. A headline naming a company already in the facts is "
    "about that same company, not a different related one.\n"
